...
Most of the code in this branch has been generated by Claude Code (Opus 4.6). The code in the [`main`](https://github.com/dkrutsko/oasis/tree/main) has been verified and accepted by a human.
